...
void decomposeTransform(hmm_mat4 in, hmm_vec3* pos, hmm_vec3* scale, hmm_quaternion* rot)
{
  pos->x = in[3][0];
  pos->y = in[3][1];
  pos->z = in[3][2];
  ...
  hmm_vec3 row1 = {in[0][0], in[0][1], in[0][2]}; 
  scale->x = Length(row1);

  hmm_vec3 row2 = {in[1][0], in[1][1], in[1][2]}; 
  scale->y = Length(row2);

  hmm_vec3 row3 = {in[2][0], in[2][1], in[2][2]}; 
  scale->z = Length(row3);
